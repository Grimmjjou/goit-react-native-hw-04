        ...
        <ImageBackground source={backImage} style={styles.backImg}>
          <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
            <View style={styles.container}>
              ...
              <TouchableOpacity style={styles.logoutButton} activeOpacity={0.5} onPress={() => navigation.navigate('Login', { screen: 'PostsScreen' })}>
                <Feather name="log-out" size={24} color="gray" />
              </TouchableOpacity>
              <Text style={styles.title}>Natali Romanova</Text>
              {data.map(el =>
                <Post key={el.id} img={el.postImg} text={el.name} msgs={0} location={el.location} />
              )}
            </View>
          </View>
        </ImageBackground>
